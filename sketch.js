...
var w114, w115, w116, w117, w118, w119, openDoor
...
function setup() {
  ...
  openDoor = createSprite(30, 50, 10, 10);
      ...
      openDoor.scale = 0.15
      //openDoor.debug = true
      //openDoor.setCollider("rectangle", 0, 0, 200, 300)
...
function handleKeyCollision(){
  ...
  function handleOpenDoorCollision(){
      if(boy.isTouching(openDoor)){
      background("white")
      textSize(50)
      fill("black")
      text("Congratulations, you won!", 100, 200)
      insectGroup.setVelocityEach(0, 0)
      ladybugGroup.setVelocityEach(0, 0)
      ladybug2.setVelocityEach(0, 0)
